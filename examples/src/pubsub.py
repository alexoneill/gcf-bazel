# Primary entrypoint for the Pub/Sub example.
def main(event, context):
  ...
  Args:
    event, dict: The dictionary with data specific to this type of event. The
      ...
      `attributes` field maps to the PubsubMessage attributes if any is
      present.
    context, google.cloud.functions.Context: Metadata of triggering event
      ...
      dictionary that describes the service API endpoint
      pubsub.googleapis.com, the triggering topic's name, and the triggering
